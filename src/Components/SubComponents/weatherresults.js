        ...
        <div>{props.data.map((ForcastDay, index) => {
            return (
                <div>
                    ...
                    <div key={ForcastDay.date}>Average Tempature for the day is {ForcastDay.day.avgtemp_f}</div>
                    ...
                    <div key={ForcastDay.date}>High tempature for the day is {ForcastDay.day.maxtemp_f}</div>
                    <div key={ForcastDay.date}>Low tempature for the day is {ForcastDay.day.mintemp_f}</div>
